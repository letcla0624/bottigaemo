  ...
  <div class="pt-[72px]">
    ...
    <div v-else>
      <div class="lg:flex justify-center items-center top-0">
        ...
        >
          <swiper-slide v-for="(pic, idx) in product.obj.imagesUrl" :key="idx">
            <img
              :src="pic"
              :alt="
                localLang === 'zh_TW' ? product.obj.title : product.obj.enTitle
              "
        ...
        >
          <div class="lg:w-4/5 xl:w-10/12 2xl:w-7/12 p-4 lg:pl-0 mt-5 xl:mt-0">
            <BreadComponent
            ...
            <div>
              ...
              <p v-if="product.obj.setSize" class="text-xs text-black/50 my-3">
                {{ $t("notice") }}
              </p>
              <button
